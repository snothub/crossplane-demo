...
kubectl --namespace crossplane-system create secret generic azure-creds-$AZURE_TENANT_NAME --dry-run=client --from-file creds=./azure-creds-$AZURE_TENANT_NAME.json -o json | kubeseal | tee azure-sealedcreds-$AZURE_TENANT_NAME.yaml
kubectl create --filename azure-sealedcreds-$AZURE_TENANT_NAME.yaml
